...
plot(seq(0.05,0.95,by=0.01), mid.length)
plot(dnorm(qnorm(seq(0.05,0.95,by=0.01))), mid.length)
```
...
mid.length <- apply(rand_sample_grid, 2, function(x) quantile(x,0.975)-quantile(x, 0.025))
plot(seq(0.05,0.95,by=0.01), mid.length)
plot(dexp(qexp(seq(0.05,0.95,by=0.01))), mid.length)
```
...
mid.length <- apply(rand_sample_grid, 2, function(x) quantile(x,0.975)-quantile(x, 0.025))
plot(seq(0.05,0.95,by=0.01), mid.length)
plot(df3(qf3(seq(0.05,0.95,by=0.01))), mid.length)
```
